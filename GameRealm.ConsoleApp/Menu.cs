...
namespace GameRealm.ConsoleApp
{
    ...
    {
       /* public static void UserMenu(Location store)
        {
            Console.WriteLine("======================================");
            Console.WriteLine($"Welcome to {store.StoreName}");
            Console.WriteLine($"Located in {store.Street}");
        ...
        public static void CustMenu(Location store, Customer customer)
        {
            Console.WriteLine("======================================");
